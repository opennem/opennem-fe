    ...
    <div class="columns">
      <div class="column">
        <record-card
          ...
          :titleUnit="'MW'"
          :unit="' MW'"
          :min="getMinObject('demand')"
          :max="getMaxObject('demand')"
          :formatString="''"
          :compare="true"
          :compareMin="getMinObject('renewables')"
          :compareMax="getMaxObject('renewables')"
        />
      </div>
      <div class="column">
        <record-card
          ...
          :titleUnit="'MW'"
          :unit="' MW'"
          :min="getMinObject('generation')"
          :max="getMaxObject('generation')"
          :formatString="''"
          :compare="true"
          :compareMin="getMinObject('renewables2')"
          :compareMax="getMaxObject('renewables2')"
        />
      </div>
      <div class="column">
        <record-card
          ...
          :titleUnit="'$/MWh'"
          :unit="''"
          :min="getMinObject('price')"
          :max="getMaxObject('price')"
          :formatString="'0,0.00'"
        />
      </div>
      <div class="column">
        <record-card
          ...
          :titleUnit="'°C'"
          :unit="'°C'"
          :min="getMinObject('temperature')"
          :max="getMaxObject('temperature')"
          :formatString="'0,0.0'"
        />
      </div>
    </div>
