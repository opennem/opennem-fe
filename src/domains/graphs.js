const GraphDomains = {
  ...
  bioenergy_biomass: {
    colour: '#1D7A7A',
    type: 'sources',
    label: 'Bioenergy (Biomass)',
    powerUnit: 'MW',
    energyUnit: 'GWh',
  },
  'bioenergy_biomass.market_value': {
    colour: '#000',
    type: 'market_value',
    label: 'Bioenergy (Biomass) Market Value',
    categoryId: 'price',
    unit: '$',
  },
  bioenergy_biogas: {
    colour: '#4CB9B9',
    type: 'sources',
    label: 'Bioenergy (Biogas)',
    powerUnit: 'MW',
    energyUnit: 'GWh',
  },
  'bioenergy_biogas.market_value': {
    colour: '#000',
    type: 'market_value',
    label: 'Bioenergy (Biogas) Market Value',
    categoryId: 'price',
    unit: '$',
  },
  distillate: {
